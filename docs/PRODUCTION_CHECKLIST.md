...
A versão de rich email adiciona `0003_rich_email.sql`, que cria a assinatura HTML por conta. **Aplique `0003` antes de publicar o Worker desta versão.**

## Publicar a versão de rich email
...
10. Responder e confirmar threading no destinatário.
11. Responder a todos e encaminhar.
12. Arquivar, mover para lixeira, restaurar e excluir permanentemente.
13. Enviar mensagem e confirmar `sent → delivered` pelo webhook.
14. Ativar notificações e verificar badge de não lidas no PWA compatível.
15. Reabrir o PWA e confirmar carregamento imediato pelo cache.
