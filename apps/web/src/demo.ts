...
export const demoDetails: Record<string, MessageDetail> = {
  'demo-1': {
    ...
    bodyHtml: '<p>Bom dia, João.</p><p>Segue o <strong>orçamento atualizado</strong> para a produção dos painéis e materiais do próximo evento.</p><p>Conseguimos manter o prazo combinado para <strong>amanhã</strong>. Estou anexando o PDF com os valores, medidas e especificações de cada peça.</p><p>Qualquer ajuste me avise.</p><p>Ana<br>Armazém da Estampa</p>',
  ...
  'demo-2': { ...demoMessages[1], ...thread, cc: [], bcc: [], bodyText: 'Uma nova venda foi confirmada para La Rumba. Acesse o painel do evento para conferir os detalhes.', bodyHtml: '<p>Uma nova venda foi confirmada para <strong>La Rumba</strong>.</p><p>Acesse o painel do evento para conferir os detalhes.</p>', attachments: [] },
  'demo-3': { ...demoMessages[2], ...thread, cc: [], bcc: [], bodyText: 'Hola, João.\n\nTe envío la lista final para el evento del sábado. Quedaron confirmadas las personas de la mesa reservada.\n\nNos vemos allá.', bodyHtml: '<p>Hola, João.</p><p>Te envío la <strong>lista final</strong> para el evento del sábado. Quedaron confirmadas las personas de la mesa reservada.</p><p>Nos vemos allá.</p>', attachments: [{ id: 'att-demo-3', filename: 'lista_invitados.xlsx', mimeType: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', sizeBytes: 92032, contentId: null, disposition: 'attachment' }] },
  'demo-4': { ...demoMessages[3], ...thread, cc: [], bcc: [], bodyText: 'Your Email Routing configuration is active and processing messages for gtrz.com.br.', bodyHtml: '<p>Your Email Routing configuration is <strong>active</strong> and processing messages for gtrz.com.br.</p>', attachments: [] }
};
